...
if(GLFW3_DIR)
	...
	if((__find_glfw_lib) AND (NOT GLFW3_LIBRARY_DEBUG) )
		...
		message(STATUS "[FindGLFW3] - ERROR: cannot find glfw3.lib debug library. Configure release instead")
...
if(GLFW3_DIR AND GLFW3_LIBS ) 
	set(GLFW3_FOUND TRUE CACHE STRING "Found glfw3" FORCE)
